...
export enum ErrorCode {
  ...
  INVALID_PROOF_SCHEMA = 'INVALID_PROOF_SCHEMA',
  INVALID_PROOF_FORMAT = 'INVALID_PROOF_FORMAT',
  
  // ZK verification errors
  ZK_VERIFICATION_FAILED = 'ZK_VERIFICATION_FAILED',
  ZK_VERIFICATION_KEY_MISSING = 'ZK_VERIFICATION_KEY_MISSING',
  ZK_VERIFICATION_KEY_INVALID = 'ZK_VERIFICATION_KEY_INVALID',
