(function (global, factory) {
	...
	var dijkstra$1 = /*#__PURE__*/Object.freeze({
		__proto__: null
	});

	var require$$7 = /*@__PURE__*/getAugmentedNamespace(dijkstra$1);
	...
	class ZeroAuth {
	    ...
	    async generateQRBase64(payload, options) {
	        ...
	        try {
	            const dataUrl = await browserExports.toDataURL(payload, opts);
	            return dataUrl;
	        }
	        catch (error) {
	    ...
	    async generateQRCanvas(payload, canvas, options) {
	        ...
	        try {
	            await browserExports.toCanvas(canvas, payload, opts);
	        }
	        catch (error) {
	            throw new QRGenerationError(error instanceof Error ? error.message : 'Failed to generate QR code');
	        }
